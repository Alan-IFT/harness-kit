...
description: Drop a redirect / pause / note signal into a running 7-stage Harness pipeline. Use when an autonomous task needs course correction without killing the session. Writes .harness/intervention.md which the PM Orchestrator picks up at the next stage boundary.
...
Stage numbers: `01` requirement-analysis · `02` solution-design · `03` gate-review · `04` development · `05` code-review · `06` qa · `07` delivery.
