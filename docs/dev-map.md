...
│       ├── verify_all.{ps1,sh}         ← Total verification (33 checks)
...
| Total verification | `verify_all` | Single source of truth for "is the repo healthy" — runs all 33 checks including both `--check` modes |
