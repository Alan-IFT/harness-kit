...
│       ├── verify_all.sh         ← Total verification (37 checks)
...
| Total verification | `verify_all` | Single source of truth for "is the repo healthy" — runs all 37 checks including both `--check` modes |
