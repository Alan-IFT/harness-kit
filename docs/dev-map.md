...
│       ├── verify_all.{ps1,sh}         ← Total verification (31 checks at v0.20.0)
...
| Total verification | `verify_all` | Single source of truth for "is the repo healthy" — runs all 31 checks (at v0.20.0) including both `--check` modes |
